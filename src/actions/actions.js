...
export const getAllUsers = () => {
    return dispatch => {
        axios.get('http://www.ohanadaily.com:8080/api/users')
            .then(items => {
                dispatch({
                    type: GET_ALL_USERS,
                    task: items.data
...
export const getUser = (id) => {
    ...
    return dispatch => {
        ...
        axios.get(`http://www.ohanadaily.com:8080/api/users/${id}`)
            .then(response => {
...
export const addUser = (user) => {
    ...
    return dispatch => {
        axios.post('http://www.ohanadaily.com:8080/users/createnew', user)
            .then(response => {
...
export const getAllDreams = () => {
    ...
    return dispatch => {
        axios.get('http://www.ohanadaily.com:8080/api/dreams')
            .then(response => {
...
export const getDream = (id) => {
    ...
    return dispatch => {
        axios.get(`http://www.ohanadaily.com:8080/api/dreams/${id}`)
            .then(response => {
...
export const editDream = (id, data) => {
    ...
    return dispatch => {
        axios.put(`http://www.ohanadaily.com:8080/api/dreams/edit_dream/${id}`, data)
            .then(response => {
...
export const addDream = (dream) => {
    ...
    return dispatch => {
        axios.post('http://www.ohanadaily.com:8080/api/dreams/new_dream')
            .then(response => {
...
export const deleteDream = (id) => {
    ...
    return dispatch => {
        axios.delete('http://www.ohanadaily.com:8080/api/dreams/delete_dream', { data: { id } })
            .then(response => {
...
export const getStore = (id) => {
    ...
    return dispatch => {
        axios.get(`http://www.ohanadaily.com:8080/api/stores/${id}`)
            .then(response => {
...
export const editStore = (id, data) => {
    ...
    return dispatch => {
        axios.put(`http://www.ohanadaily.com:8080/api/stores/edit_store/${id}`, data)
            .then(response => {
                // console.log('ACTION EDIT DATA: ', response.data)
...
export const addStore = (store) => {
    ...
    return dispatch => {
        axios.post("http://www.ohanadaily.com:8080/api/stores/create_store", store)
            .then(response => {
...
export const getAllPurchases = () => {
    return dispatch => {
        axios.get('http://www.ohanadaily.com:8080/api/purchased')
            .then(items => {
...
export const getPurchase = (id) => {
    ...
    return dispatch => {
        axios.get(`http://www.ohanadaily.com:8080/api/purchased/${id}`)
            .then(response => {
...
export const addPurchase = () => {
    ...
    return dispatch => {
        axios.post('http://www.ohanadaily.com:8080/api/purchased/new_purchase')
            .then(response => {
